...
FIND_PATH(GLIB_glib_2_INCLUDE_DIR glib.h
                                  PATHS /opt/homebrew/Cellar/glib/2.78.1/include/glib-2.0 ${GLIB2_ROOT}/include ${GLIB2_ROOT}/include/glib-2.0 /usr/local/include/glib-2.0 /usr/include/glib-2.0 /opt/local/include/glib-2.0
                                  ENV INCLUDE DOC "Directory containing glib.h include file")

FIND_PATH(GLIB_glibconfig_2_INCLUDE_DIR glibconfig.h
                                        PATHS /opt/homebrew/Cellar/glib/2.78.1/lib/glib-2.0/include ${GLIB2_ROOT}/include ${GLIB2_ROOT}/include/glib-2.0 ${GLIB2_ROOT}/lib/include ${GLIB2_ROOT}/lib/glib-2.0/include /usr/local/include/glib-2.0 /usr/include/glib-2.0 /usr/lib/glib-2.0/include /usr/local/lib/glib-2.0/include /opt/local/lib/glib-2.0/include
...
FIND_LIBRARY(GLIB_glib_2_LIBRARY NAMES glib-2.0 libglib-2.0
                                 PATHS /opt/homebrew/Cellar/glib/2.78.1/lib ${GLIB2_ROOT}/bin ${GLIB2_ROOT}/win32/bin ${GLIB2_ROOT}/lib ${GLIB2_ROOT}/win32/lib /usr/local/lib /usr/lib /opt/local/lib
                                 ENV LIB
